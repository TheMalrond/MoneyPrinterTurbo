...
3. Descreva os **temas visuais em inglês** (guiam a busca de imagens no banco Pexels), ex.: `hands counting cash money, open book reading closeup`.
...
- Termos visuais **específicos** evitam clipes de desenho/3D no lugar de fotografia real.
